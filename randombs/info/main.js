...
document.getElementById("bandwidth").innerHTML = "Bandwidth: " + network.downlink + " Mbps";
...
document.getElementById("connectionType").innerHTML = "Connection Type: " + network.type.charAt(0).toString().toUpperCase() + network.type.toString().splice(1);
